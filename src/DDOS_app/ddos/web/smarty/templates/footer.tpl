<div id="footer" style="width: 1000px; margin-top:5px;">
	<div class="content">
		<div id="deic" style="width: 80%" class="left">
			<table class="tbl">
				<tr>
					<td class="footer">
						    <span>
    	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390 145.86" height="30">
	        <title>DeiC</title>
		...
		<div id="support" class="content right" style="padding-top: 23px">DDPS Support: <a href="mailto:support@ddps.dk">ddps-info@deic.dk</a> </div>
	</div>
</div>
</body>
</html>